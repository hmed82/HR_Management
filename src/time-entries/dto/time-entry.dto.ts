...
export class TimeEntryDto {
  ...
  @ApiProperty() @Expose() employeeId: number;
  @ApiProperty() @Expose() date: Date;
  @ApiProperty() @Expose() clockIn: string;
  @ApiProperty({ nullable: true }) @Expose() clockOut: string | null;
  @ApiProperty({ enum: TimeEntryStatus }) @Expose() status: TimeEntryStatus;
